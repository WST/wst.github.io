...
.. raw:: html
   ...
   <div class="swiper-slider-container" style="width: 100%; height: 480px; margin: 20px 0;">
       <img src="/docs/_static/images/oldkbs/1.jpg" alt="Classic keyboard 1">
       <img src="/docs/_static/images/oldkbs/2.jpg" alt="Classic keyboard 2">
       <img src="/docs/_static/images/oldkbs/3.jpg" alt="Classic keyboard 3">
       <img src="/docs/_static/images/oldkbs/4.jpg" alt="Classic keyboard 4">
       <img src="/docs/_static/images/oldkbs/5.jpg" alt="Classic keyboard 5">
       <img src="/docs/_static/images/oldkbs/6.jpg" alt="Classic keyboard 6">
   </div>
...
+--------+-------------+------------------+
| DIN-5  | PS/2        | Description      |
+========+=============+==================+
| Pin 1  | Data        | Data line        |
+--------+-------------+------------------+
| Pin 2  | Not used    | Not connected    |
+--------+-------------+------------------+
| Pin 3  | Ground      | Common ground    |
+--------+-------------+------------------+
| Pin 4  | +5V (VCC)   | Power supply     |
+--------+-------------+------------------+
| Pin 5  | Clock       | Clock signal     |
+--------+-------------+------------------+
...
.. image:: /_static/images/full_din-ps2.png
   :width: 320px
...
.. raw:: html
   ...
   <div class="swiper-slider-container" style="width: 100%; height: 480px; margin: 20px 0;">
      <img src="/docs/_static/images/newkbs/1.jpg" alt="Modern keyboard 1">
      <img src="/docs/_static/images/newkbs/2.jpg" alt="Modern keyboard 2">
   </div>
...
Non-100% keyboards like this one may look beautiful at first, but then you suddenly discover the absense of the **Insert** button (which is used, for example, to select files in Midnight Commander).

.. raw:: html

   <div class="swiper-slider-container" style="width: 100%; height: 480px; margin: 20px 0;">
      <img src="/docs/_static/images/newkbs/short.jpg" alt="Non-100% modern keyboards 1">
   </div>
...
* `Keebox Shenpo cyrillic <https://www.ebay.com/itm/405557225467>`_
